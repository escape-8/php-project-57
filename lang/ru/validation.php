...
return [
    ...
    */
    ...
    'lt' => [
        ...
        'file' => 'Поле :attribute должно быть меньше :value в килобайтах.',
    ...
    */
    ...
    | вместо этого использовать что-то более удобное для чтения, например «Адрес электронной почты» вместо
